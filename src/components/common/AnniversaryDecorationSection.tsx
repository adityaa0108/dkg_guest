...
const ANNIVERSARY_PRODUCTS: Product[] = [
  {
    id: 501,
...
export default function AnniversaryDecorationSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ANNIVERSARY_PRODUCTS.map((product) => (
          ...
          <div className="text-center mt-10">
            <Link
              href="/products/anniversary-decoration"
