...
const ServiceCard = ({ service, isHovered, onHover, onLeave }: ServiceCardProps) => {
  return (
    <a
      ...
      className="block w-[20vw] h-[28.13vw] relative rounded-[1.67vw] overflow-hidden group cursor-pointer transition-all duration-500 shrink-0"
    ...
    >
      ...
      <div
        className={`absolute left-[0.73vw] w-[20vw] h-[2.5vw] transition-all duration-500 ${
          isHovered ? "top-[1.25vw]" : "top-[-2.6vw]"
        }`}
      >
      ...
      <div
        className={`absolute left-[0.73vw] w-[20vw] h-[2.5vw] transition-all duration-500 ${
          isHovered ? "bottom-[1.25vw]" : "bottom-[-3.23vw]"
        }`}
      >
...
const ExploreMoreCard = () => {
  return (
    <a
      href="/categories/birthdays"
      className="flex-shrink-0 w-[20vw] h-[28.13vw] bg-gradient-to-l from-purple-500 to-pink-500 rounded-[1.67vw] overflow-hidden flex flex-col items-center justify-center gap-[1.67vw] cursor-pointer hover:shadow-2xl transition-all duration-500 group"
    >
      ...
      <div className="w-full max-w-[87.5vw] bg-neutral-50 rounded-[1.67vw] shadow-[0px_56px_120px_0px_rgba(0,0,0,0.15)] outline outline-1 outline-offset-[-1px] outline-pink-900/10 p-[2.5vw] relative">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-[2.5vw] h-[2.5vw] bg-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 -ml-[1.25vw] disabled:opacity-50 disabled:pointer-events-none"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-[2.5vw] h-[2.5vw] bg-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 -mr-[1.25vw] disabled:opacity-50 disabled:pointer-events-none"
          ...
          <div ref={emblaRef} className="overflow-hidden touch-pan-x cursor-grab active:cursor-grabbing select-none">
            <div className="flex gap-[2.5vw] -ml-[2.5vw]">
              {services.map((service) => (
                <div key={service.id} className="flex-[0_0_20vw] min-w-0 pl-[2.5vw]">
                  <ServiceCard
                    service={service}
              ...
              <div className="flex-[0_0_20vw] min-w-0 pl-[2.5vw]">
                <ExploreMoreCard />
              </div>
            </div>
          </div>
